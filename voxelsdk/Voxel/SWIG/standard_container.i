...
%define %standard_container_methods(container...)
  container();
  ...
  #ifdef SWIG_EXPORT_REVERSE_ITERATOR_METHODS
...
%define %standard_sequence_methods_common(sequence)
  
  %standard_container_methods(%arg(sequence));
...
%define %standard_sequence_methods(sequence)
  
  %standard_sequence_methods_common(%arg(sequence));
...
%define %standard_sequence_methods_val(sequence...)
